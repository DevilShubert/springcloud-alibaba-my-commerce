 ...
 * */
@Configuration
@ConditionalOnClass(Feign.class) // 类路径下必须检测到Feign.class的存在才会加载当前bean
@AutoConfigureBefore(FeignAutoConfiguration.class) // 必须已经完成FeignAutoConfiguration.class的自动配置后才会进行当前类的自动配置

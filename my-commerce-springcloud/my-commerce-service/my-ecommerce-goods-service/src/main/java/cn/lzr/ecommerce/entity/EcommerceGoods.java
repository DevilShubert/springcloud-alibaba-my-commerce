package cn.lzr.ecommerce.entity;


import cn.lzr.ecommerce.constant.BrandCategory;
import cn.lzr.ecommerce.constant.GoodsCategory;
import cn.lzr.ecommerce.constant.GoodsStatus;
import cn.lzr.ecommerce.converter.BrandCategoryConverter;
import cn.lzr.ecommerce.converter.GoodsCategoryConverter;
import cn.lzr.ecommerce.converter.GoodsStatusConverter;
...
public class EcommerceGoods {
    ...
    /**
     * <h2>将ORM映射的实体对象转成 GoodsInfo 对象</h2>
     * */
    public GoodsInfo toGoodsInfo(){
        ...
        // 将String类型存在数据库中的商品属性转换为GoodsInfo.GoodsProperty
    ...
    public static EcommerceGoods toEcommerceGoods(GoodsInfo goodsInfo) {
        ...
        // 将GoodsInfo.GoodsProperty转换为String类型存在数据库中的商品属性

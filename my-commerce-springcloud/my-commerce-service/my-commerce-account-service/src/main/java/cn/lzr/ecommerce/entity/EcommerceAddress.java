...
public class EcommerceAddress {
    ...
    /**
     * <h2>根据 userId + AddressItem 得到一条 EcommerceAddress</h2>
     * */
    public static EcommerceAddress toOneEcommerceAddress(Long userId, AddressInfo.AddressItem addressItem){
